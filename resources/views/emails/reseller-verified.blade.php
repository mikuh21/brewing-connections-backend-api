...
<head>
    ...
    <title>Reseller Account Verified</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background:#ffffff;border-radius:12px;border:1px solid #e8ddd0;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:24px;line-height:1.6;font-size:15px;">
                            ...
                            <p style="margin:0 0 12px;">Great news. Your reseller account has been verified by the BrewHub admin team.</p>
                            <p style="margin:0 0 16px;">You can now log in and access your reseller dashboard.</p>
                            <p style="margin:0 0 22px;">
                                <a href="{{ route('login') }}" style="display:inline-block;background:#2E5A3D;color:#ffffff;text-decoration:none;padding:10px 16px;border-radius:8px;font-weight:600;">Log In to BrewHub</a>
                            </p>
