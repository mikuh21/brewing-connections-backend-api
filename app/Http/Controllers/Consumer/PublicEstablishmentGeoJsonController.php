        ...
        $features = $establishments->map(function ($est) {
            ...
            return [
                ...
                'properties' => [
                    ...
                    'name' => $est->name,
                    'type' => $est->type,
                    'owner_id' => $est->owner_id ? (int) $est->owner_id : null,
                    'user_id' => $est->user_id ? (int) $est->user_id : null,
                    'owner_user_id' => $est->user_id ? (int) $est->user_id : ($est->owner_id ? (int) $est->owner_id : null),
            ...
            ->map(function ($reseller) {
                return [
                    ...
                    'properties' => [
                        ...
                        'user_id' => (int) $reseller->id,
                        'owner_user_id' => (int) $reseller->id,
