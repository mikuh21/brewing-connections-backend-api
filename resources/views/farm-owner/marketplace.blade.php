...
<div
    x-data="{
        ...
        init() {
            ...
            try {
                const savedIds = JSON.parse(localStorage.getItem('farmOwnerHiddenProducts') || '[]');
        ...
        saveHiddenProducts() {
            localStorage.setItem('farmOwnerHiddenProducts', JSON.stringify(this.hiddenProductIds));
        },
        isHidden(productId) {
