...
<div
    x-data="{
        ...
        init() {
            ...
            try {
                const savedIds = JSON.parse(localStorage.getItem('cafeOwnerHiddenProducts') || '[]');
        ...
        saveHiddenProducts() {
            localStorage.setItem('cafeOwnerHiddenProducts', JSON.stringify(this.hiddenProductIds));
        },
        isHidden(productId) {
