...
@section('content')
<div class="reseller-map-page h-screen -m-8 p-6 overflow-hidden bg-[#F5F0E8] text-[#3A2E22]">
...
@media (max-width: 767px) {
    ...
    .reseller-map-page > .max-w-full {
        height: auto !important;
        min-height: calc(100dvh - 6rem);
        gap: 0.75rem !important;
    }

    .reseller-map-page header {
        padding: 0.8rem !important;
        border-radius: 14px !important;
        align-items: flex-start;
    }

    .reseller-map-page .map-header-search {
        width: 100%;
        flex-wrap: wrap;
        gap: 0.45rem !important;
    }

    .reseller-map-page .map-header-search .relative {
        width: 100%;
    }

    .reseller-map-page #map-filter {
        flex: 1;
        min-width: 8rem;
    }

    .reseller-map-page #map-barangay-search {
        width: 100% !important;
    }

    .reseller-map-page #map-barangay-search-btn {
        min-height: 2rem;
    }

    .reseller-map-page .map-wrapper {
        border-radius: 14px !important;
        padding: 0.6rem !important;
        min-height: 62vh;
    }

    .reseller-map-page #filter-panel {
        margin-bottom: 0.6rem !important;
        border-radius: 14px !important;
    }

    .reseller-map-page #map {
        min-height: 52vh;
    }
}
</style>
