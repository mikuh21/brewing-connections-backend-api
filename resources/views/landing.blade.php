                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-8 card-hover reveal-left">
                    ...
                    <ul class="space-y-2 font-body">
                        <li class="flex items-center gap-2 text-[#F3E9D7]">
                            <span class="text-current inline-flex items-center justify-center" aria-hidden="true">
                                <svg class="w-2.5 h-2.5" viewBox="0 0 12 12" fill="none">
                                    <rect x="2" y="2" width="8" height="8" rx="1.1" transform="rotate(45 6 6)" fill="currentColor"></rect>
                                </svg>
                            </span>
                ...
                <div class="mt-5 grid grid-cols-1 gap-3 sm:mt-6 lg:grid-cols-2 lg:gap-4">
                    ...
                    @empty
                        <div class="col-span-full rounded-2xl border border-dashed border-white/14 bg-white/4 px-5 py-6 text-center sm:px-6 sm:py-7">
                            <p class="text-base font-semibold text-[#F3E9D7]/80 font-poppins">
                                No product ratings yet
                            </p>
                            <p class="mt-2 text-sm text-[#F3E9D7]/80 font-body">
