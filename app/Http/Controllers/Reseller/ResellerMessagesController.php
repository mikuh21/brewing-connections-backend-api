...
class ResellerMessagesController extends Controller
{
    public function index(?Conversation $conversation = null)
    {
        ...
        return view('reseller.messages', compact('conversation', 'conversations', 'messages', 'users'));
    }
    ...
    public function messagesStore(Request $request)
    {
        ...
        if ($existingConversation) {
            ...
            return redirect()->route('reseller.messages.show', $existingConversation);
        }
        ...
        return redirect()->route('reseller.messages.show', $conversation);
    }
